...
- **AI Image Generation**: Create unique images from text prompts or base images using Google Gemini Imagen 4 API
- **Image-to-Image Styling**: Apply styles or modifications to existing local images
